package com.litiengine.Adventure.hp;
...
public class PlayerHealthBar implements IRenderable {
	...
	public void render(Graphics2D g) {
		BufferedImage border = Resources.images().get("images/hp_bar_border_thin.png");
		BufferedImage fill = Resources.images().get("images/hp_bar_fill_thin.png");
